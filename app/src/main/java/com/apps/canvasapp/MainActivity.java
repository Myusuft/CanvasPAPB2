...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPaintText.setColor(ResourcesCompat.getColor(getResources(), R.color.colorText, null));
            ...
            public void onClick(View view) {
                ...
                if (mOffset==OFFSET) {
                    ...
                    if (mOffset < halfWidth && mOffset < halfHeight) {
                        ...
                        int mColorAccent = ResourcesCompat.getColor(getResources(), R.color.orange, null);
